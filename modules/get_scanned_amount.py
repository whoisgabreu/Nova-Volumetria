...
class CarregamentoTroncal:
    ...
    def get_scanned_amound(self, shipmentNo, planned_arrival_time, actual_arrival_time):
        ...
        for record in scanned_waybillNo:
            ...
            if actual_arrival_time >= target_time and actual_arrival_time <= target_time2:
